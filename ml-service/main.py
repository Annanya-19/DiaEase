...
feature_names = ['glucose','iob','carbs','activity','hour','trend','mins_since_meal','glucose_velocity','prev_hypo_24h']
...
def predict(req: PredictRequest):
    ...
    importances = {f: round(float(i), 3) for f, i in zip(feature_names, model.feature_importances_)}
    return {
        "riskScore": risk,
        "alertLevel": alert,
